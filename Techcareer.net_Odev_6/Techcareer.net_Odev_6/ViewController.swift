...
class ViewController: UIViewController {
    ...
    let kampanyaList = [Kampanya(imageName: "kampanya-2"),
    ...
    let mutfakList = [Mutfak(imageName: "balik", labelText: "Balık"),
...
//                backgroundView?.backgroundColor = UIColor.blue.withAlphaComponent(0.3) //Or any transparent color that matches with the `navigationBar color`
